...
function DiffViewer({ diff }) {
  ...
  const renderLine = (line, index, side) => {
    ...
    return (
      ...
      >
        {/* Line type indicator */}
        <div className="w-6 flex items-center justify-center py-1 bg-gray-100 border-r border-gray-200">
          {getLineTypeIcon(line.type)}
        </div>
        
        {/* Line number */}
        <div className="w-12 bg-gray-100 text-gray-500 text-right pr-2 py-1 border-r border-gray-200 select-none">
    ...
    <div className="mb-6">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600">
          ...
          <div className="flex items-center gap-1">
            <div className="w-3 h-3 bg-red-200 rounded-sm border border-red-300"></div>
            <span>Removed</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
        <div className="bg-gray-50 border-b border-gray-200 px-4 py-2">
          <div className="flex">
            <div className="w-1/2 text-sm font-medium text-gray-700 flex items-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Original
            </div>
            <div className="w-1/2 text-sm font-medium text-gray-700 flex items-center gap-2 pl-4">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
